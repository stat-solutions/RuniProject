...
@Component({
  selector: 'app-vbi-layout',
  templateUrl: './vbi-layout.component.html',
  styleUrls: ['./vbi-layout.component.scss']
})
export class VbiLayoutComponent implements OnInit {
  ...
  this.router.navigate([
          '/dashboardadmin/viewbranchinvestemnts/viewportinvestemnentsbranches',
