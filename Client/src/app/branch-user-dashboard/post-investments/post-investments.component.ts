...
@Component({
  selector: 'app-post-investments',
  templateUrl: './post-investments.component.html',
  styleUrls: ['./post-investments.component.scss']
})
export class PostInvestmentsComponent implements OnInit {
